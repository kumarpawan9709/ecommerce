                    ...
                    <form class="forms-sample" method="POST" action="{{route('product.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="form-group ">
                        <label for="exampleInputMobile">Quantity</label>
                         <input type="text" class="form-control" name="quantity" id="exampleInputMobile" placeholder="Quantity">
                       </div>
                       <div class="form-group ">
                       ...
                       <div class="form-group ">
                        <label for="exampleInputMobile">MRP Price</label>
                         <input type="text" class="form-control" name="mrp_price" id="exampleInputMobile" placeholder="MRP Price">
                       </div>
                       <div class="form-group ">
                        <label for="exampleInputMobile">Base Price</label>
                         <input type="text" class="form-control" name="base_price" id="exampleInputMobile" placeholder="Base Price">
                       </div>
                       <div class="form-group">
                        <label for="exampleInputName1">Description</label>
                        <input type="text" class="form-control" name="pro_description" id="exampleInputName1" placeholder="Description">
                       </div>
                      <div class="form-group">
